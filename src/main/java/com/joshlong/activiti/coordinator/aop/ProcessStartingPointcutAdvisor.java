 ...
 * method invocations with the {@link com.joshlong.activiti.coordinator.annotations.ProcessStart}
 * annotation.
 * 
 * @author Josh Long
 * @since 1.0
...
public class ProcessStartingPointcutAdvisor implements PointcutAdvisor, Serializable {
	...
	/**
	 * matches any method containing the {@link com.joshlong.activiti.coordinator.annotations.ProcessStart} annotation.
	 */
	...
	protected Pointcut buildPointcut(){
		...
		return result.union( new AnnotationMethodMatcher( ProcessStart.class));
	}
