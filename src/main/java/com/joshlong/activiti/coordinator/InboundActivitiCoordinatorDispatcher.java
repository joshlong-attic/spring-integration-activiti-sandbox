 ...
 * called <code>confirm-receipt</code>, an {@link com.joshlong.activiti.coordinator.ActivitiState}
 * annotation would specify something like:
 *
 * <code>
...
public class InboundActivitiCoordinatorDispatcher  extends AbstractEndpoint {
	 ...
	 * the appropriately registered {@link com.joshlong.activiti.coordinator.ActivitiHandler}
	 * components.
	 */
	class ActivitiDispatcherMessageHandler implements MessageHandler {
